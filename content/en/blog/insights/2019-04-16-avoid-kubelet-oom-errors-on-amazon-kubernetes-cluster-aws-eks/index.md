...
meta_description: Best practice to setup nodes with Cloudwatch on Amazon Kubernetes Cluster (AWS EKS). Using autoscaling, memory limits and eviction limits.
...
[cloudformation]: ./bootstrapArguments.png
