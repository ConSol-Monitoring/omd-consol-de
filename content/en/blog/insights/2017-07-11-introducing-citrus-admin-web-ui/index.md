...
It has been a while since the last release in the [Citrus](http://christophd.github.io/citrus/) universe. It took us some time to get the new Citrus release [2.7.2](http://christophd.github.io/citrus/) ready for you. 
...
[https://labs.consol.de/maven/repository/com/consol/citrus/citrus-admin-web](https://labs.consol.de/maven/repository/com/consol/citrus/citrus-admin-web)
...
![project-dashboard.png](project-dashboard.png)
...
![config-endpoints.png](config-endpoints.png)
...
![test-info.png](test-info.png)
![test-sources.png](test-sources.png)
...
![test-execute.png](test-execute.png)
...
![test-messages.png](test-messages.png)
