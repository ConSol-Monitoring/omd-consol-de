...
featured_image: /assets/2017-09-18-docker-headless-vnc-container-1.2.0-released/vnc_container_view.png
...
<div style="position: relative; float: right; margin-right: 1em; margin-bottom: 1em; width: 30%;"><img src="{{page.featured_image}}"></div>
