...
meta_description: Guideline how to add an application to a data plane of Istio or Red Hat OpenShift Service Mesh
...
![sequence_request_call.png](sequence_request_call.png)
...
![kiali_overview_without_opentracing.jpg](kiali_overview_without_opentracing.jpg)
...
![jaeger_without_tracing.jpg](jaeger_without_tracing.jpg)
...
![jaeger_with_tracing.jpg](jaeger_with_tracing.jpg)

The graph for a single requests looks like this:

![jaeger_with_tracing_spans.jpg](jaeger_with_tracing_spans.jpg)
