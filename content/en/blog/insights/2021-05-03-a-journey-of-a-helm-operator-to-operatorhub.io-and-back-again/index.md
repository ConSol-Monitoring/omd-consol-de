...
meta_description: Simple example how to create OLM supported Helm operator by using the operator skd. It is using bundle format and is tested with Scorecard and KUTTL for integration tests.
...
![installed_nginx-sts_operator.jpg](installed_nginx-sts_operator.jpg)

![installed_nginx-sts_operator_details.jpg](installed_nginx-sts_operator_details.jpg)

We are now able to create a new CRD. The form and yaml view look very good for a starting point.

![installed_nginx-sts_operator_new_crd_form.jpg](installed_nginx-sts_operator_new_crd_form.jpg)

Let's do a couple of changes:

- I would like to see the ConSol logo, when the operator has been installed.
...
![installed_nginx-sts_operator_install_new.jpg](installed_nginx-sts_operator_install_new.jpg)

On the operator overview page the description looks fine as well and shows the ConSol Logo.

![installed_nginx-sts_operator_details_new.jpg](installed_nginx-sts_operator_details_new.jpg)
...
![installed_nginx-sts_operator_new_crd_yaml.jpg](installed_nginx-sts_operator_new_crd_yaml.jpg)
...
![installed_nginx-sts_operator_new_crd_form_new.jpg](installed_nginx-sts_operator_new_crd_form_new.jpg)
...
![installed_nginx-sts_operator_installed_crd_details.jpg](installed_nginx-sts_operator_installed_crd_details.jpg)
...
- [Source code of the examples](https://github.com/olaf-meyer/helm-operator)
