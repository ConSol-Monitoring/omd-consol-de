...
### New backup format
This release includes a new backup format which allows cross platform restores even if the old version is not installed at all. Read more about backups on the [__OMD Backup__](/omd/backup_and_restore.html) Page.
