...
meta_description: Java 9 incubates a brand new HTTP client with HTTP/2 support, and finally offers a sleek API for communication via HTTP. Let's have a look at the new API and see some examples in action.
status: public
author: Jens Klingen
author_url: https://twitter.com/jklingen
featured_image: duke-blueprint.png
categories:
- development
tags:
- java9
...
---
<div style="position: relative; float: right; margin-right: 1em; margin-bottom: 1em;"><img src="duke-blueprint.png"></div>
...
[Java 9 modules]: https://labs.consol.de/blog/2017/02/13/getting-started-with-java9-modules.html
[Fabian's Devoxx talk about HTTP/2]: https://labs.consol.de/blog/2015/11/13/devoxx-talks-http2-citrus.html#dr-fabian-staber-unrestful-web-services-with-http2
