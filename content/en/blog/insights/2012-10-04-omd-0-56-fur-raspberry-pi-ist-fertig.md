...
Alle anderen können OMD einfach per deb-Paket installieren. Dazu wird (in Anlehnungen an die Anweisungen von Sven auf der Seite des <a href="/de/nagios/omd-repository/">ConSol-OMD-Repositories</a>) erstmal das zuständige Repository registriert.
...
<a href="/assets/2012-10-04-omd-0-56-fur-raspberry-pi-ist-fertig/raspberry-temp-pnp1.png"><img src="/assets/2012-10-04-omd-0-56-fur-raspberry-pi-ist-fertig/raspberry-temp-pnp1.png" alt="Temperatur und CPU-Frequenz des Raspberry Pi" title="raspberry-temp-pnp" width="595" height="561" class="alignleft size-full wp-image-3859" /></a>