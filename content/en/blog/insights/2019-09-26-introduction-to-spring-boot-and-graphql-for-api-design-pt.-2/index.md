...
featured_image: graphql_spring_boot_part2.png
categories:
- development
tags:
- SpringBoot
...
---
<div style="position: relative; float: right; margin-right: 1em; margin-bottom: 1em;"><img src="graphql_spring_boot_part2.png"></div>
...
[In the first part](https://labs.consol.de/blog/2019/05/02/graphql_spring_boot_introduction.html) of this series we already learned about REST and GraphQL. I explained what each of them is good for and in which case you should use REST and when you should use GraphQL instead.
...
<img src="springboot_initialize.png">
