...
meta_description: OpenShift 4.3 installation on VMware vSphere with static IP addresses and terraform
...
categories:
  ...
  - platform
  - openshift
# one or more tags, e.g. names of technologies, frameworks, libraries, languages, etc. -  avoid proliferation of tags by using already existent tags, see https://labs.consol.de/tags/
tags:
  - openshift
  - redhat
  - k8s
