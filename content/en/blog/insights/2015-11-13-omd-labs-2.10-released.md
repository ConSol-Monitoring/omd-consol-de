...
featured_image: /assets/2015-10-21-activate-nagflux/screenshot2.png
tags:
- omd
title: OMD 2.10 Labs Edition Released
---

[__OMD Labs Edition__](/omd/) 2.10 in has been released today. The OMD Labs Edition is based on the standard [__OMD__](http://omdistro.org/) but adds some
...
It's easy to [__enable grafana graphing__](/omd/packages/grafana/) with the `omd config` menu. It's even possible
to use both in parallel to make a smooth migration.

<a title="Grafana Graphs" style="float: left;" rel="lightbox[omd labs]" href="/assets/2015-10-21-activate-nagflux/screenshot2.png"><img src="/assets/2015-10-21-activate-nagflux/screenshot2.png" alt="Grafana Graphs" width="40%" height="40%" /></a>
...
### Coshsh
Another new component in OMD Labs is the [__Coshsh__](/omd/packages/coshsh/) configuration generator which create
