...
featured_image: /assets/2015-10-21-activate-nagflux/screenshot1.png
tags:
- Grafana
...
![Thruk mit Grafana Graphen 1](/assets/2015-10-21-activate-nagflux/screenshot1.png)

![Thruk mit Grafana Graphen 2](/assets/2015-10-21-activate-nagflux/screenshot2.png)
...
![omd config - Schritt 1](/assets/2015-10-21-activate-nagflux/omd-config-1.png)

![omd config - Schritt 2A](/assets/2015-10-21-activate-nagflux/omd-config-2A.png)

![omd config - Schritt 2B](/assets/2015-10-21-activate-nagflux/omd-config-2B.png)

![omd config - Schritt 3A](/assets/2015-10-21-activate-nagflux/omd-config-3A.png)

![omd config - Schritt 3B](/assets/2015-10-21-activate-nagflux/omd-config-3B.png)

![omd config - Schritt 4A](/assets/2015-10-21-activate-nagflux/omd-config-4A.png)

![omd config - Schritt 4B](/assets/2015-10-21-activate-nagflux/omd-config-4B.png)

![omd config - Schritt 5A](/assets/2015-10-21-activate-nagflux/omd-config-5A.png)

![omd config - Schritt 5B](/assets/2015-10-21-activate-nagflux/omd-config-5B.png)

![omd config - Schritt 6](/assets/2015-10-21-activate-nagflux/omd-config-6.png)
