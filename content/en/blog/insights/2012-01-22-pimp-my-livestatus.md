...
<a href="/assets/2012-01-22-pimp-my-livestatus/Shinken-Broker-Old.png"><img src="/assets/2012-01-22-pimp-my-livestatus/Shinken-Broker-Old-300x225.png" alt="Shinken Failover Scenario with local SQLite databases" title="Shinken-Broker-Old" width="300" height="225" class="alignleft size-medium wp-image-3349" /></a>
...
<a href="/assets/2012-01-22-pimp-my-livestatus/Shinken-Broker-New.png"><img src="/assets/2012-01-22-pimp-my-livestatus/Shinken-Broker-New-300x225.png" alt="Shinken Livestatus broker with a pluggable SQLite backend" title="Shinken-Broker-New" width="300" height="225" class="alignleft size-medium wp-image-3360" /></a>Modifying the configuration means a little inconvenience to you, but looking at the image to the left it should be clear that it opens the livestatus module up to a broader range of database backends.
