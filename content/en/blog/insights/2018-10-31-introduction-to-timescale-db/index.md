...
featured_image: timescale-tiger-logo.png
...
<div style="position: relative; float: right; margin-left: 1em; margin-right: 1em; margin-bottom: 1em;"><img src="timescale-tiger-logo.png"></div>
...
![route corresponding to the table with GPS data](example-path.png "route corresponding to the table with GPS data")
...
![decision tree whether to use TimescaleDB](decide-timescaledb.png "decision tree whether to use TimescaleDB")

The "100 millions" (rows of data) number has been taken from the following graph:
![TimescaleDB vs PostgreSQL insert rate](timescale-vs-postgres-insert-rate.png "TimescaleDB vs PostgreSQL insert rate")
...
![ConSol - JCon](consol-belsenplatz-jcon.png "ConSol - JCon")
And the second part is the path leading back to the ConSol Düsseldorf (Kanzlerstraße 8):
![JCon - ConSol](jcon-to-consol.png "JCon - ConSol")
