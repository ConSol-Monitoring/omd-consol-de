...
<a href="http://labs.consol.de/projects/maven/maven-rbc-plugin/rbc-example_report.html"><img src="example-report.png" alt="Example maven-rbc-plugin report (click for details)"></a>