...
<div>
<a href="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/project-structure.png"><img src="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/project-structure-300x167.png" alt="project-structure" width="300" height="167" class="alignnone size-medium wp-image-6106" /></a>
</div>
**8. Create Run Configuration
In the *Run/Debug Configurations</em> dialog, add a new *Docker Deployment</em> configuration
<div>
<a href="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/run-configuration-01.png"><img src="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/run-configuration-01-300x193.png" alt="run-configuration-01" width="300" height="193" class="alignnone size-medium wp-image-6108" /></a>
</div>
Set the *Name</em> to *Docker deploy</em>, and the *Container name</em> to *docker-deploy</em>.
<div>
<a href="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/run-configuration-02-container-name.png"><img src="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/run-configuration-02-container-name-300x193.png" alt="run-configuration-02-container-name" width="300" height="193" class="alignnone size-medium wp-image-6109" /></a>
</div>
...
<div>
<a href="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/run-configuration-03-container-settings.png"><img src="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/run-configuration-03-container-settings-300x193.png" alt="run-configuration-03-container-settings" width="300" height="193" class="alignnone size-medium wp-image-6111" /></a>
</div>
As *Before launch</em>, add a step to build the artifact <code>wildfly-helloworld.war</code>.
<div>
<a href="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/run-configuration-04-build-artifact-before-launch.png.png"><img src="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/run-configuration-04-build-artifact-before-launch.png-300x193.png" alt="run-configuration-04-build-artifact-before-launch.png" width="300" height="193" class="alignnone size-medium wp-image-6112" /></a>
</div>
...
<div>
<a href="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/running.png"><img src="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/running-300x202.png" alt="running" width="300" height="202" class="alignnone size-medium wp-image-6114" /></a>
</div>
...
<div>
<a href="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/inspect.png"><img src="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/inspect-300x202.png" alt="inspect" width="300" height="202" class="alignnone size-medium wp-image-6116" /></a>
</div>
**11. View in Browser
...
<div>
<a href="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/browser.png"><img src="/assets/2015-03-31-intellij-idea-docker-plugin-on-ubuntu-linux/browser-300x164.png" alt="browser" width="300" height="164" class="alignnone size-medium wp-image-6117" /></a>
</div>