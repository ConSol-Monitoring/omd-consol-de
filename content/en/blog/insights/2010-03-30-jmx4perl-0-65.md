...
Yeah, spring is coming and the growing energy needs some space to expand to ;-) jmx4perl goes into its next round with version [0.65][2] containing a lot of new, exciting features.
