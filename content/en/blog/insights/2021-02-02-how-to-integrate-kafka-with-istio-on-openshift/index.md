...
meta_description: Guideline how to send messages from an example application to Kafka while running in an Istio control plane on OpenShift/Kubernetes
...
- create the projects and the needed operators,
...
![screenshot_kiali1.jpg](screenshot_kiali1.jpg)

![screenshot_kiali2.jpg](screenshot_kiali2.jpg)
...
- [Kafka Master Course](https://youtu.be/jhXRFG1896s)
