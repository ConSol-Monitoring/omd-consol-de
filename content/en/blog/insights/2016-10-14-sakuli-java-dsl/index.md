...
date: '2016-10-14'
featured_image: container_view_small.png
tags:
- Sakuli
title: Containerized UI-Tests in Java with &#35;Sakuli and &#35;Docker
---
...
<div style="text-align: center"><img src="container_view_small.png" alt=""></div>
...
After enter `mvn clean test` the maven build will start and execute the `FirstExampleTest` at your local System. The Firefox browser should start up and execute two small tests on the [Citrus Integration Testing] website `http://www.citrusframework.org/`.  If some errors occurs please see [Java DSL - Installation], how to setup your local system.
 ...
 ![sakuli test in firefox](/assets/2016-10-14-sakuli-java-dsl/local_view.png)
...
* Image pattern `citrus_logo.png` ![citrus_logo](/assets/2016-10-14-sakuli-java-dsl/citrus_logo.png) is rendered correct.
* ConSol logo `consol_logo.png` ![consol_logo](/assets/2016-10-14-sakuli-java-dsl/consol_logo.png)  is at the bottom of the page loaded.
...
![look into the sakuli container](/assets/2016-10-14-sakuli-java-dsl/container_view.png)

For further information about using [Sakuli] and [Docker], take a look at [Sakuli Docker Containers]. The example code is placed on **[github.com/ConSol/sakuli-examples](https://github.com/ConSol/sakuli-examples)**
...
[Sakuli Java DSL]: https://github.com/ConSol/sakuli/blob/master/docs/java-DSL.md
