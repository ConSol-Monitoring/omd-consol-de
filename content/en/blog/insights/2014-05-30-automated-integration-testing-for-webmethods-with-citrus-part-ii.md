---
author: Jan Zahalka
date: '2014-05-30T18:26:56+00:00'
slug: automated-integration-testing-for-webmethods-with-citrus-part-ii
tags:
- Citrus
title: Automated Integration Testing for webMethods  with Citrus Part II
---
...
<strong>Maven or Ant?</strong>

Basically, Citrus support both options – you are free in your choice of the build system to use to drive your Citrus tests. Typically a Maven setup is preferred since Maven reduces the necessary project setup clutter one has to face when using Ant. Check <a href="http://www.citrusframework.org/tutorials-maven.html" target="_blank">this quickstart</a> if you want to let Maven create your project structure for you.
...
<strong>Citrus Ant Template Project</strong>
