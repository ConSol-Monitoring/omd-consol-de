...
<img src="coshsh_logo.png" alt="Coshsh" width="500"/>
...
### Download
The suggested and supported (if I am having a good day) way to use Coshsh is by installing [OMD](https://omd.consol.de/docs/omd/). With OMD, batteries and everything else you need to run Coshsh is included.
